    ...
    <div className="page-speed">
      ...
      <ul className="list-unstyled">
        {Object.keys(data?.categories || {}).map((key) => (
          <li key={key} style={{ display: 'inline-block', margin: '5px', border: '1px solid #ccc', padding: '10px', borderRadius: '5px' }}>
            <strong>{key}</strong>: 
            <span style={{ color: data.categories[key].score >= 0.75 ? 'green' : data.categories[key].score >= 0.5 ? 'orange' : 'red' }}>
